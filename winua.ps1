...
try {
    $rustdeskInstaller = "$solviaFolderPath\rustdesk-1.4.8-x86_64.msi"
    Invoke-WebRequest -Uri "https://sw-deploy.solvia.ch/rustdesk-1.4.8-x86_64.msi" -OutFile $rustdeskInstaller -ErrorAction Stop
