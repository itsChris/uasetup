...
try {
    $rustdeskInstaller = "$solviaFolderPath\rustdesk-1.3.6-x86_64.msi"
    Invoke-WebRequest -Uri "https://sw-deploy.solvia.ch/rustdesk-1.3.6-x86_64.msi" -OutFile $rustdeskInstaller -ErrorAction Stop
