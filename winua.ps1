...
try {
    $rustdeskInstaller = "$solviaFolderPath\rustdesk-1.3.8-x86_64.msi"
    Invoke-WebRequest -Uri "https://sw-deploy.solvia.ch/rustdesk-1.3.8-x86_64.msi" -OutFile $rustdeskInstaller -ErrorAction Stop
